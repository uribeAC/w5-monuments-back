...
describe("Given a monument instance", () => {
  describe("When is instantiated with Hokage Monument", () => {
    test("Then it should have the name: 'Hokage Monument'", () => {
    ...
    test("Then it should have the description: 'Is the most representative trait of Konohagakure. It is a mountain that has had the faces of all the Hokage carved into the stone.'", () => {
    ...
    test("Then it should have the url that opens a image of Hokage Monument", () => {
    ...
    test("Then it should have the country: 'Land of Fire'", () => {
    ...
    test("Then it should have the city: 'Konohagakure'", () => {
